...
$miq_account_client_state = array(
    ...
    'basePath' => miq_account_deployment_path(),
    'apiUrl' => miq_account_public_path('account_api.php'),
    'chatHistoryMaxBytes' => (int) miq_account_config()['max_chat_history_bytes'],
    'accountUrl' => miq_account_public_path('account.php'),
    'workspaceUrl' => miq_account_public_path('workspace'),
...
<link rel="stylesheet" href="assets/css/theme.css?v=20260806.4">
