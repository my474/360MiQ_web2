          ...
          <div class="dropdown miq-account-nav-item">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="miqAccountMenu">
              <div class="dropdown-header miq-account-dropdown-header">
                ...
                <strong><?php echo htmlspecialchars($miq_nav_user['display_name'], ENT_QUOTES, 'UTF-8'); ?></strong>
              </div>
              <a class="dropdown-item" href="workspace"><i class="fas fa-layer-group fa-fw"></i> My Workspace</a>
              <a class="dropdown-item" href="workspace?tab=watchlists"><i class="fas fa-star fa-fw"></i> Watchlists</a>
              ...
              <a class="dropdown-item" href="account_sso.php?target=new-post"><i class="fas fa-pencil-alt fa-fw"></i> Article Editor</a>
     ...
     if ($(this).text() == "繁"){
        ...
        <div class="miq-header-search">
            ...
            <!--<input id="autocomplete2" size="12" class="form-control mr-sm-2 copyMe" style="max-width:150px;" type="search" placeholder="Stock Code" aria-label="Search" name="code" spellcheck="false"  maxlength="25" autofocus required>-->
                ...
                <button class="btn btn-outline-primary my-2 my-sm-0" type="submit" aria-label="Stock Search" style="width:39px;padding-right:2px"><i class="fas fa-search"></i></button>
            </form>
        </div>
    </div>
</nav>
...
<script src="assets/js/account.js?v=20260806.2" defer></script>
<!-- jQuery UI -->
