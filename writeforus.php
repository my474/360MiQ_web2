...
?>
  ...
  <p><strong>Please note:</strong> Only relevant articles that include a suitable thumbnail or image will be featured in these locations. Placement is not guaranteed for every submission.</p>
    <ul>
