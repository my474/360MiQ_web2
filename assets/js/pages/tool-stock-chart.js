(function () {
    ...
    function ensureEngineReady() {
        ...
        engineReadyPromise = loadScript('data-tool-stock-chart-runtime', 'assets/js/stock-chart-engine/pine-script-runtime.js?v=20260718.6', 'PineScriptRuntime')
            .then(function () {
                return loadScript('data-tool-stock-chart-engine', 'assets/js/stock-chart-engine/stock-chart-engine.js?v=20260718.39', 'StockChartEngine');
            })
