...
(function (root, factory) {
  ...
  function drawingToolIconSvg(type, renderKind) {
    ...
    var icons = {
      ...
      pitchfork: '<path d="M2 8 22 3"/><path d="M5 13 22 8"/><path d="M9 18 22 13"/><path d="M5 13 9 18"/>',
      schiffPitchfork: '<path d="M4 21 10 5"/><path d="M7 12 22 7"/><path d="M10 16 22 11"/><path d="M10 5 22 1"/>',
