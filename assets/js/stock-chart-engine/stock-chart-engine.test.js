...
assert.ok(chart.toolbar.innerHTML.indexOf('data-sce-share-action="copy-layout"') !== -1);
assert.ok(chart.toolbar.innerHTML.indexOf('data-sce-share-action="download-layout"') !== -1);
...
assert.strictEqual(typeof bestShareUrl.includeData, 'boolean');
