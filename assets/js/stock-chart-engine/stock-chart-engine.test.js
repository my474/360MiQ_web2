...
assert.ok(StockChartEngine.drawingTools.pitchfork.icon.indexOf('M7 5 22 1') !== -1);
assert.ok(StockChartEngine.drawingTools.pitchfork.icon.indexOf('M11 17 22 13') !== -1);
assert.ok(StockChartEngine.drawingTools.pitchfork.icon.indexOf('M7 5 11 17') !== -1);
