...
assert.ok(watermarkText.includes('TEST'));
assert.ok(watermarkText.includes('Example Holdings'));
assert.ok(watermarkText.includes('\u6e2c\u8a66\u516c\u53f8'));
const lightWatermarkCommand = chart.canvas.commands.find((command) => command.type === 'fillText' && command.text === 'TEST');
...
assert.ok(watermarkText.includes('Example Holdings'));
const darkWatermarkCommand = chart.canvas.commands.find((command) => command.type === 'fillText' && command.text === 'TEST');
