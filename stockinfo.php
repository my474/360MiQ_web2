...
<head>
    ...
    <link rel="stylesheet" href="assets/css/stock-account-tools.css?v=20260806.2">
...
.stock-advanced-chart-link:hover,
.stock-advanced-chart-link:focus {
  background: #006bff;
  border-color: #006bff;
  color: #fff;
  text-decoration: none;
